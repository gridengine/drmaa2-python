...
def test_reserved_start_time_attr():
    ...
    assert(int((ri.reserved_start_time-POSIX_EPOCH).total_seconds()) == int((reserved_start_time-POSIX_EPOCH).total_seconds()))
...
def test_reserved_end_time_attr():
    ...
    assert(int((ri.reserved_end_time-POSIX_EPOCH).total_seconds()) == int((reserved_end_time-POSIX_EPOCH).total_seconds()))
